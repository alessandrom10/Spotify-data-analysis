...
\lstdefinelanguage{MongoDB}{
  morekeywords={db, aggregate, \$group, \_id, \$avg, \$sort, sort},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]'"
...
db.spotify_music.aggregate([
	{"$group" : {
		...
		"track_popularity" : {"$avg" : "$track_popularity"}
	}}
]).sort({
	"track_popularity" : -1
})
...
[
{
	...
	track_popularity: 47.74487016524424
},
{
	_id: {
	music_genre: 'latin'
	},
	track_popularity: 47.026576139670226
},
{
	_id: {
	music_genre: 'rap'
	},
	track_popularity: 43.21545422902889
},
{
	_id: {
	music_genre: 'rock'
	},
	track_popularity: 41.72833770955363
},
{
	_id: {
	music_genre: 'r&b'
	},
	track_popularity: 41.22353157797827
},
{
	_id: {
	music_genre: 'edm'
	},
	track_popularity: 34.83352639417508
}
]
\end{lstlisting}
\end{algorithm}
